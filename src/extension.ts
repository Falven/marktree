 ...
 * It respects .gitignore patterns and skips ignored paths. Hidden files and directories are not filtered out.
 ...
 * - Minimal logging: only before and after the scan, and errors when reading directories.
 ...
 * @param outputChannel The VS Code output channel for logging start/end of scan and errors.
